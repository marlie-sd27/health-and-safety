    ...
    public function run()
    {
        DB::table('submissions')->insert([
            ...
            [
                ...
                'data' => 'Admin+Rep=Ken+Matieshen&Alternate+Rep=Dave+Corbett&IUOE+Rep=John+doe&IUOE+Alternate=Jane+Doe&CCTA+Rep=Jane+Austin&CCTA+Alternate=Janet+Austin&IUOE+or+CCTA+rep=&Designate+Name=Ryan+Andres&Designate+Location=Maintenance+Yard&Backup+Name=Barry+Rawlek&Backup+Location=Maintenance+Yard&Forms+Required+to+be+on+hand+%28in+office+of+First+Aid+Room%29%5B+Injury+Report+Form+6a%5D=on&Forms+Required+to+be+on+hand+%28in+office+of+First+Aid+Room%29%5B+First+aid+Record+Form%5D=on&Forms+Required+to+be+on+hand+%28in+office+of+First+Aid+Room%29%5B+Incident+Investigation+Form%5D=on&Forms+Required+to+be+on+hand+%28in+office+of+First+Aid+Room%29%5B+New+Worker+Site+Orientation+Form%5D=on&Health+and+Safety+Notice+Board+%28this+information+must+be+posted%29%5B+JOHS+Committee+names+and+locations%5D=on&Health+and+Safety+Notice+Board+%28this+information+must+be+posted%29%5B+First+Aid+Attendants+and+locations%5D=on&Health+and+Safety+Notice+Board+%28this+information+must+be+posted%29%5B+Previous+3+months+of+JOHS+Committee+minutes%5D=on&Instructed+staff+on+how+to+access+Safety+Data+Sheets=Yes&Reviewed+relevant+Safe+Work+Procedures+with+staff=Yes&Conducted+Site+Orientations+for+any+new+school+staff=Yes&Reviewed+district+Working+Alone+Program+with+staff=Yes&Signature+of+Principal%2FSupervisor=Marlie+Dueck&Date=2020-08-20',
            ...
            [
                ...
                'data' => 'Asbestos+fibres+can+cause=Asbestosis&Who+is+notified+in+case+of+an+asbestoss+spill%3F=Manager+of+Facilities+%26+Transportation&What+colour+is+the+Asbestos+Management+Plan+binder%3F=Blue&Where+is+the+Asbestos+Management+Plan+located+at+your+site%3F=School+Office&What+is+the+Facilities+Manager+Responsibilities%3F=choose+the+OH%26S+team',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
                ...
                'data' => 'Asbestos+fibres+can+cause=Asbestosis&Who+is+notified+in+case+of+an+asbestoss+spill%3F=Manager+of+Facilities+%26+Transportation&What+colour+is+the+Asbestos+Management+Plan+binder%3F=Yellow&Where+is+the+Asbestos+Management+Plan+located+at+your+site%3F=School+Office&What+is+the+Facilities+Manager+Responsibilities%3F=choose+the+OH%26S+team',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [

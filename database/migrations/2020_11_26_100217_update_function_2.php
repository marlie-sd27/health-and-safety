...
class UpdateFunction2 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    BEGIN
    IF (old.interval IS DISTINCT FROM new.interval OR old.first_occurence_at IS DISTINCT FROM new.first_occurence_at) THEN

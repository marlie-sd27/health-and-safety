        ...
        <article class="container">
            ...
            <form method="get" action="{{ route('report') }}">
                ...
                <label>Search by site:
                    <select class="form-control text-reset" type="text" placeholder="Search" name='site'>
                        <option @if ($site == "") {{ 'selected' }} @endif></option>
                        <option @if ($site == "100 Mile Elementary") {{ 'selected' }} @endif>100 Mile Elementary</option>
                        <option @if ($site == "100 Mile Maintenance") {{ 'selected' }} @endif>100 Mile Maintenance</option>
                        <option @if ($site == "150 Mile Elementary") {{ 'selected' }} @endif>150 Mile Elementary</option>
                        ...
                        <option @if ($site == "Mile 108 Elementary") {{ 'selected' }} @endif>Mile 108 Elementary</option>

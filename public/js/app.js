...
$(document).ready(function () {
  ...
  var j = parseInt($("input[name='field_id[]']").last().val()) + 1;
  ...
  $('#addSection').on('click', function () {
    ...
    $('<article>' + '<img id="removeSection" src="/images/delete.png" height="25em;" alt="remove"/>' + '<div class="toggle-expand"></div>' + '<div class="container">' + '<input type="hidden" value="' + i + '" name="s_id[]" />' + '<div class="form-group">' + '<label for="section_title">Title</label>' + '<input class="form-control" type="text" name="section_title[]" placeholder="Title">' + '</div>' + '<div class="form-group">' + '<label for="section_description">Description</label>' + '<textarea class="form-control" name="section_description[]" placeholder="Description"></textarea>' + '</div><h3>Add fields to your section</h3>' + '<div id="fields">' + '</div><button class="btn btn-info" id="addField" type="button">Add Field</button> ' + '</div></article>').appendTo(section);
    i++;
...
module.exports = __webpack_require__(/*! C:\Users\marlie.russell\Laravel\healthandsafety\resources\js\app.js */"./resources/js/app.js");
